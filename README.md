...
A project-portfolio review app: try the read-only demo, or open one standalone HTML
...
- [Read-only demo](https://fcabouat.github.io/project-review/demo/project-review.html?sample&lang=en)
  — explore fictional data in read-only mode; it never reads or writes your portfolio.
...
[explore the read-only demo](https://fcabouat.github.io/project-review/demo/project-review.html?sample&lang=en).
The demo swaps the complete fictional portfolio when changing
language; use the ordinary editor link above for your own data.
...
Releases use local Gitflow; GitHub only verifies pushed refs, deploys Pages from
`main`, and publishes immutable `v*` tags. See [CONTRIBUTING.md](CONTRIBUTING.md#releasing)
for the tested git-flow AVH version, one-time setup and exact release commands.
...
See [CONTRIBUTING.md](CONTRIBUTING.md) for branch and release procedures.
