...
describe('theme — the embedded-face rules', () => {
  refused([
    ...
    [
      'a face weight is an integer 100–900 (invalidFontWeight)',
      { type: 'ChangeSetting', setting: 'fontFaces', after: [face({ weight: '99' })] },
    ],
    [
      'a face weight stays under 900 (invalidFontWeight)',
      { type: 'ChangeSetting', setting: 'fontFaces', after: [face({ weight: '901' })] },
    ],
    [
