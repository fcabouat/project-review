...
export const PARSE_ERROR_CODES = [
  ...
  'emptyId',
  /** An id/reference containing an unpaired Unicode surrogate. */
  'invalidId',
  ...
  'invalidFontFace',
  /** Two faces naming the same family, weight and style after defaults. */
  'duplicateFontFace',
  /** An embedded face `weight` that is not an integer in 100–900 nor an
