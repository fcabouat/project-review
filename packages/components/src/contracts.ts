 ...
 * (Route, PersistenceControl) in `screens/contracts.ts`; `Dispatch` lives
 * here because the editor widgets (FreeSlideCard, ImportExportDialog) speak
 * it too, and editor/ may not reach into screens/.
 */
