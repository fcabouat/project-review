...
{:else if slide.type === 'divider'}
  <SlideDivider {portfolio} categoryId={slide.categoryId} number={slide.number} />
...
{:else if slide.type === 'archives'}
  <SlideArchives {portfolio} {page} {total} {logo} />
{:else if slide.type === 'previousDecisions'}
  <SlidePreviousDecisions {portfolio} {page} {total} {logo} />
{/if}
