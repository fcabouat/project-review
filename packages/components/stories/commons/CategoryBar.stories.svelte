<script module lang="ts">
  ...
  import { categoryBars, categoryOfGroup, groupKey } from '@project-review/core/projections'
...
<Story name="Gallery" asChild>
  <div class="cats">
    {#each bars as b (groupKey(b.group))}
      {@const category = categoryOfGroup(sample, b.group)}
      <div class="cat-row" style:--cat={catColor(category.color)}>
        <span class="cat-n">{category.name}</span>
